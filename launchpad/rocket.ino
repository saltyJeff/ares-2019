...
const char NameText[] PROGMEM = {"BMP_altitude,BNO_w,BNO_x,BNO_y,BNO_z,MPU_accelX,MPU_accelY,MPU_accelZ,Pressure_cc,Pressure_fuel,Pressure_ox,Pressure_press,timestamp"};
