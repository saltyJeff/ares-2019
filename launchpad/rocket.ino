...
const char NameText[] PROGMEM = {"BMP_altitude,BNO_w,BNO_x,BNO_y,BNO_z,MPU_accelX,MPU_accelY,MPU_accelZ,timestamp"};
const char TypeText[] PROGMEM = {"float,float,float,float,float,float,float,float,uint32_t"};
const char ModuleText[] PROGMEM = {"BMP,BNO,MPU,Radio,SdCard"};
...
const __FlashStringHelper *Rocket::MODULE_NAMES[5] = {
	FS(ModuleBMPText),
	FS(ModuleBNOText),
	FS(ModuleMPUText),
	FS(ModuleRadioText),
