...
namespace SdCard {
    ...
    public:
        ...
        virtual void refresh() {
            file.write(Rocket::startDelim, 2);
            file.write(Rocket::DATA_START, Rocket::DATA_LEN);
            file.write(Rocket::endDelim, 2);
            bytesWritten += Rocket::DATA_LEN + 4;
            if(bytesBeforeFlush - bytesWritten < Rocket::DATA_LEN + 4) { //if not enough bytes to finish the next message
                file.flush();
                bytesWritten = 0;
            }
        }
